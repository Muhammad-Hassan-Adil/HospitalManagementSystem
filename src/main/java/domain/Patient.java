...
public class Patient extends Person{
    ...
    public Patient(){}
    public Patient(String fname, String Lname, String Address, int cnic, int phoneNo, LocalDate dob,
                   Gender gender, String disease, String status, LocalDate dateOfAdmission){
